...
export const DEMO_WEEK = {
  ...
  weekEnd: "2026-08-21",
  days: [
    { weekday: "Monday", date: "2026-08-17", lessons: [demoDay("M1.T1.L1", "Taking Apart Numbers and Shapes", "6.EE.3", "I can write equivalent expressions using the distributive property.", "I can show the same area two ways and match each part.", "distributive property; equivalent; area model")] },
    { weekday: "Tuesday", date: "2026-08-18", lessons: [demoDay("M1.T1.L2-D1", "Searching for Common Ground", "6.NS.4", LESSON.learningIntention, LESSON.successCriteria, "factor; factor pair; multiple; greatest common factor")] },
    { weekday: "Wednesday", date: "2026-08-19", lessons: [demoDay("M1.T1.L2-D2", "Common Ground: GCF and LCM", "6.NS.4", "I can use GCF and LCM to solve problems.", "I can decide whether a problem is asking for a GCF or an LCM and defend my choice.", "greatest common factor; least common multiple")] },
    { weekday: "Thursday", date: "2026-08-20", lessons: [demoDay("M1.T1.L3", "Composing and Decomposing Numbers", "6.NS.4", "I can break numbers into prime factors.", "I can build a factor tree and read the prime factorization off it.", "prime; composite; prime factorization")] },
    { weekday: "Friday", date: "2026-08-21", lessons: [demoDay("M1.T1.L4", "Did You Get the Part?", "5.NF.4", "I can multiply fractions using an area model.", "I can shade an area model to show a fraction of a fraction.", "numerator; denominator; area model")] },
  ],
};
