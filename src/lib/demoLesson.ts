...
export const DEMO_WEEK = {
  ...
  weekEnd: "2026-08-21",
  days: [
    { weekday: "Monday", date: "2026-08-17", lessons: [demoDay("M1.T1.L1", "Taking Apart Numbers and Shapes", "6.EE.3", "I can write equivalent expressions using the distributive property.", "I can show the same area two ways and match every part of the box to a part of the expression.", "distributive property - Multiplying a sum is the same as multiplying each part and then adding.\nrate: 5 x 9 -> 5 x (4 + 5) -> 20 + 25\nequivalent; area model")] },
    ...
    { weekday: "Wednesday", date: "2026-08-19", lessons: [demoDay("M1.T1.L2-D2", "Common Ground: GCF and LCM", "6.NS.4", "I can use GCF and LCM to solve problems.", "I can decide whether a problem is asking for a GCF or an LCM and defend my choice.", "least common multiple - The smallest multiple that two numbers share. Count by each number until the same one shows up in both lists.\ntable: 4 = 4, 8, *12, 16 | 6 = 6, *12, 18, 24\ngreatest common factor")] },
    { weekday: "Thursday", date: "2026-08-20", lessons: [demoDay("M1.T1.L3", "Composing and Decomposing Numbers", "6.NS.4", "I can break numbers into prime factors.", "I can build a factor tree and read the prime factorization off it.", "prime factorization - A number written as a product of primes only. Split it into any factor pair, then keep splitting until every branch is prime.\nsteps: Split into a factor pair | Keep splitting composites | Stop at primes\nprime; composite")] },
...
function demoDay(lessonCode: string, title: string, standard: string, learningIntention: string, successCriteria: string, vocab: string) {
  return {
    ...
    standard,
    learningIntention,
    selectedSuccessCriterion: successCriteria,
