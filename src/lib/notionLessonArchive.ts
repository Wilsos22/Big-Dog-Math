...
// 2026-07-27: trimmed to the one REAL source, matching notionLessons.ts -
// 3282eba1 is schemaless and d1c8e7b0 never existed (it 404s; querying it
// added dead latency to every archive read).
